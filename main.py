...
# === STEP 2: Read Bands ===
green, profile_g = read_band(green, DOWNSAMPLE)
nir, profile_n = read_band(nir, DOWNSAMPLE)
red, profile_r  = read_band(red, DOWNSAMPLE)
blue, profile_b  = read_band(blue, DOWNSAMPLE)
...
show_ndwi_maps(fcc, ndwi, water_pixels, masked_nonwater, NDWI_THRESHOLD, OUTPUT_DIR)
...
# Feature matrix: each row = [R, G, B, NIR] of a water pixel
